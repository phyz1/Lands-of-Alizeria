...
.hellspeak				{font-family: "FK Agincort.kz", Pterra; font-size: 100%;}
...
.grenzelhoftian			{font-family: "American TextC", Pterra;}
.kazengunese 			{font-family: "Yuji Boku", Pterra;}
.kazenaccent			{font-family: "Asiana", "Pterra"; font-size: 100%;}
.otavan					{font-family: "Bodega Script", "Pterra";}
.posh					{font-family: "Parisish", "Pterra"; font-size: 130%;}
.etruscan				{font-family: "BeaumarchaisC", "Pterra"; font-size: 200%;}
.gronnic				{color: #95ca86; font-family: "TolkienCyr", "Pterra"; font-size: 100%;}
...
.sac					{font-family: "MasonAlternate", Pterra;}
