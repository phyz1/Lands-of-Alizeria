...
/datum/outfit/job/roguetown/mercenary/combattante/pre_equip(mob/living/carbon/human/H)
	...
	if(H.mind)
		...
		H.adjust_skillrank_up_to(/datum/skill/combat/swords, 5, TRUE) //One-trick, rely mostly on their rapier.
		H.adjust_skillrank_up_to(/datum/skill/combat/knives, 3, TRUE)
		H.adjust_skillrank_up_to(/datum/skill/misc/reading, 2, TRUE)
		H.adjust_skillrank_up_to(/datum/skill/craft/crafting, 3 , TRUE) //All Mercs get this, why though?
		H.adjust_skillrank_up_to(/datum/skill/craft/masonry, 3, TRUE)	//All Mercs get this, why though?
		H.adjust_skillrank_up_to(/datum/skill/craft/carpentry, 3, TRUE)	//All Mercs get this, why though?
		H.adjust_skillrank_up_to(/datum/skill/misc/athletics, 4, TRUE)
		H.adjust_skillrank_up_to(/datum/skill/misc/tracking, 1, TRUE)
