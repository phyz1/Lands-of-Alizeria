...
//Age ranges
#define AGE_ADULT			"Молодой"
#define AGE_MIDDLEAGED		"Взрослый"
#define AGE_OLD				"Старый"
...
#define HE_HIM			"Он/Его"
#define SHE_HER			"Она/Её"
...
#define VOICE_TYPE_MASC	"Мужской"
#define VOICE_TYPE_FEM	"Женский"
#define VOICE_TYPE_ANDR	"Неестественный"
