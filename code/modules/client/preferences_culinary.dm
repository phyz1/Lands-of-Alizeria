...
/datum/preferences/proc/print_culinary_page(mob/user)
	...
	dat += "<div class='culinary-item'><b>Любимая еда:</b> <span class='culinary-icon'>[food_icon]</span> <span class='culinary-text'><a href='byond://?_src_=prefs;preference=choose_food;preference_type=[CULINARY_FAVOURITE_FOOD];task=change_culinary_preferences'>[encode_special_chars(food_name)]</a></span></div>"
	dat += "<div class='culinary-item'><b>Любимый напиток:</b> <span class='culinary-icon'>[drink_icon]</span> <span class='culinary-text'><a href='byond://?_src_=prefs;preference=choose_drink;preference_type=[CULINARY_FAVOURITE_DRINK];task=change_culinary_preferences'>[encode_special_chars(drink_name)]</a></span></div>"
	dat += "<div class='culinary-item'><b>Ненавистная еда:</b> <span class='culinary-icon'>[hated_food_icon]</span> <span class='culinary-text'><a href='byond://?_src_=prefs;preference=choose_hated_food;preference_type=[CULINARY_HATED_FOOD];task=change_culinary_preferences'>[encode_special_chars(hated_food_name)]</a></span></div>"
	dat += "<div class='culinary-item'><b>Ненавистный напиток:</b> <span class='culinary-icon'>[hated_drink_icon]</span> <span class='culinary-text'><a href='byond://?_src_=prefs;preference=choose_hated_drink;preference_type=[CULINARY_HATED_DRINK];task=change_culinary_preferences'>[encode_special_chars(hated_drink_name)]</a></span></div>"
...
/datum/preferences/proc/show_culinary_ui(mob/user)
	...
	var/datum/browser/popup = new(user, "culinary_customization", "<div align='center'>Вкусовые предпочтения</div>", 345, 215)
	popup.set_content(dat.Join())
	popup.open(FALSE)
