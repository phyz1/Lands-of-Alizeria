...
/datum/species/elf/sun
	...
	id = "elfc"
	is_subrace = TRUE
	origin_default = /datum/virtue/origin/racial/aliz/sacifia
	origin = "Сацифия"
	base_name = "Эльф"
	desc = "<b>Солнечный Эльф</b><br>\
	Солнечные эльфы всегда занимали статус одной из самых неблагородных рас после развала империи. Занимая высокие должности, после развала им было дозволено сыскать определëнные успехи лишь в области магии. \
	Те, кто нужных талантов для этого не имел - либо уходили в леса к общинам лесных эльфов, либо пользовались своей красотой, выступая слугами для знатных господ. Заговор ночных эльфов во многом лишь усугубил эту ситуацию, присвоив солнечным эльфам репутацию легкомысленных заговорщиков, которые неспособны в полной мере понять возможные последствия своих поступков. На данный момент солнечные эльфы стараются держаться своих общин в городах, однако порой знать устраивает на них гонения, когда например их становится слишком много, либо когда в семье правителя всплывает бастард-полукровка.<br>\
