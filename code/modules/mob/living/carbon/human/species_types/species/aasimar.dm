...
/datum/species/aasimar
	...
	origin = "Монфор"
	desc = "<b>Аасимар</b><br>\
	Единственная раса, что была признана достойной среди появившихся после разрушения империи. \
	Аасимары далеко не сразу, но смогли доказать всему миру, что ими движут в большинстве своëм \
	благодеятельные цели и желания, основой которых является взаимопонимание, доброта и справедливость. На \
	текущий момент они дошли до того, что просто напросто не позволяют себе находиться на неблагодарных должностях, которые обычно занимает чернь. \
	Темболее они больше, чем кто-либо еще заботится о чистоте своей крови, не допуская в себе мысль о возможном соитии с представителями иных рас. \
	Естественно, находятся исключения, однако если правда всплывает наружу - под давлением остальных аасимаров, провинившийся нередко накладывает на себя руки, \
	кем бы он ни был. Из-за этого пускай их положение в обществе и оценивается весьма высоко - на самый верх никто в здравом уме аасимара поставить не рискнëт.<br>\
