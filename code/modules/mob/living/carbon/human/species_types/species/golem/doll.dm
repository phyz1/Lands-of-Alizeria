...
/datum/species/golem/porcelain
	...
	psydonic = TRUE
	base_name = "Construct"
	desc = "<b>Конструкт</b><br>\
	Шедевры современных технологий. Воплощение идеального баланса между точной работы с механизмами и утешением хаотичного потока магии. \
	Многие до сих пор спорят, обладают ли конструкты душой подобной люду, но одно ясно точно - созданы они были исключительно для служения. \
	Благодаря своему искусственному происхождению и теоретическому отсутствию возможности лгать и предавать - им было дозволено \
	сосуществовать со знатью, нередко выполняя их часть работы. Конструкты не обладают собственной личностью в привычном понимании. \
	Во время создания они перенимают часть 'души' жертвующего кровь, и затем считают его своим хозяином. Лишь когда он умирает \
	- конструкт получает шанс обрести собственное сознание, однако чаще он просто сходит с ума.<br> \
