...
/datum/species/elf/dark
	...
	Интриганы, тираны и кровожадные садисты. Путëм обмана они смогли вырасти из презираемой расы в расу, которую принято бояться. \
	Общий враг в лице лесных эльфов объединил разобщëнные пещерные племена дроу, а их последующая сплочëнность стала частью культуры на протяжении веков. \
	Естественно, остаются народы что всей душой ненавидят тëмных эльфов, однако невозможно не признать тот факт, что люди часто доверяют дроу \
	важные должности, надеясь играть на их предсказуемости и потаëнных желаниях. У кого-то это получается, у кого-то нет.<br>\
