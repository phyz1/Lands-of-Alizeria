...
/datum/species/dwarf/mountain
	...
	id = "dwarfm"
	psydonic = TRUE
	origin_default = /datum/virtue/origin/racial/aliz/grimm
	origin = "Гриммшталь"
	sub_name = "Дварф"
	clothes_id = "dwarf"
	desc = "<b>Дварф</b><br>\
	Те, кто был рождëн верно служить людям и те, кто построил их первый город. Во время развала империи - дварфийский народ поднял восстание, \
	сбежав на земли старого материка. Долгое время после этого велась война между дварфами, \
	эльфами и людьми, где каждый обвинял друг друга в произошедшем. Тем не менее, на сегодняшний день мир между расами продолжается уже почти \
	тысячу лет, и дварфы за это время смогли позабыть многие прошлые обиды. Знать же в свою очередь научилась в должной мере признавать \
	ярое трудолюбие и пылкий характер дварфов, за что им было дозволено самим представлять знать. \
...
/datum/species/dwarf/mountain/get_skin_list_tooltip()
	return list(
		...
		"Brass <span style='border: 1px solid #161616; background-color: #[SKIN_COLOR_BRASS_DWARF];'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>" = SKIN_COLOR_BRASS_DWARF,
