...
/datum/species/human/halfelf
	...
	is_subrace = TRUE
	base_name = "Человек"
	desc = "<b>Полукровка</b><br>\
	Гибрид различных рас, представители которых появляются из-за кровосмешения. Являются буквально мусором для каждой благородной расы. \
	Полукровки не имеют собственных земель или даже 'народности' как таковой. Им никогда не позволяют управлять кем-либо, зачастую используя как рабов.<br>\
