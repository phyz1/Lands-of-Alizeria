...
/datum/species/elf/wood
	...
	origin = "Сацифия"
	sub_name = "Лесной Эльф"
	desc = "<b>Elf</b><br>\
	Если Аасимары были признаны достойными несмотря на своë происхождение, то с лесными эльфами ситуация сложилась ровно наоборот. Когда-то они были частыми гостями дворцов, нередко помогали путникам в лесах. \
	Однако из-за общей ненависти ночных эльфов и дварфов - несколько веков лесным эльфам навязывали репутацию блудников, убийц и каннибалов. \
	Всë дошло до того, что общая ненависть растянулась и у остальных рас, что привело к гонениям эльфов. \
	На текущий момент лесные эльфы являются весьма разобщëнной расой, где каждый думает лишь о себе, либо же максимум о своих близких. Им не доверяют руководящие посты, а также неохотно принимают даже на малозначимые должности.<br>\
