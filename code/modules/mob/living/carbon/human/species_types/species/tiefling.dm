...
/datum/species/tieberian
	name = "Тифлинг"
	id = "tiefling"
	origin_default = /datum/virtue/origin/racial/aliz/altamir
	origin = "Альтамир"
	desc = "<b>Тифлинг</b><br>\
	Тифлинги - Наиболее презираемая раса с момента своего появления. Отвратительный и пугающий вид, подкрепляемый ранними действиями \
	некоторых индивидов. Во многих королевствах тифлинги подвергаются гонениям, либо же им просто не позволяют занимать какие-либо должности кроме шлюх и разнорабочих. \
	Многие, не смирившись с подобной судьбой - уходят в авантюристы и зачастую имеют в этом деле успех. \
	Во многих группах сохраняется примета, что иметь тифлинга в отряде - к удаче, но частенько не для него самого. \
