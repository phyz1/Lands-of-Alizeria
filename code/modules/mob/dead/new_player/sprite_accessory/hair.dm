...
/datum/sprite_accessory/hair/head/uneven
	name = "(A) Uneven"
	icon_state = "uneven"

/datum/sprite_accessory/hair/head/tailed
	name = "(A) Tailed"
	icon_state = "tailed"

/datum/sprite_accessory/hair/head/sheafsponytail
	name = "(A) Sheafs ponytail"
	icon_state = "sheafsponytail"

/datum/sprite_accessory/hair/head/classicmodern
	name = "(A) Classic modern"
	icon_state = "classicmodern"

/datum/sprite_accessory/hair/head/highponytail
	name = "(A) High ponytail"
	icon_state = "highponytail"

/datum/sprite_accessory/hair/head/groomed
	name = "(A) Groomed"
	icon_state = "groomed"

/datum/sprite_accessory/hair/head/aristocratic
	name = "(A) Aristocratic"
	icon_state = "aristocratic"

/datum/sprite_accessory/hair/head/sideponytail
	name = "(A) Side ponytail"
	icon_state = "sideponytail"

/datum/sprite_accessory/hair/head/strictalt
	name = "(A) Strict"
	icon_state = "strictalt"
