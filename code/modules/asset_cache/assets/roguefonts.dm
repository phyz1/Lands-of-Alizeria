/datum/asset/simple/roguefonts
	...
	assets = list(
		...
		"monfit.ttf" = 'interface/fonts/languages/aavnic.ttf',
		"grimm.ttf" = 'interface/fonts/languages/aavnic.ttf',
		"alt.ttf" = 'interface/fonts/languages/aavnic.ttf',
		"sac.ttf" = 'interface/fonts/languages/dwarf.ttf',
		"jar.ttf" = 'interface/fonts/languages/aavnic.ttf',
	)
