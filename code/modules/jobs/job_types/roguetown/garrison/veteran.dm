/datum/job/roguetown/veteran
	...
	tutorial = "Ты знал бой всю свою жизнь. Нет такого способа убить человека, который ты не опробовал бы на полотнах самой войны. Ты не назвал бы себя героем — герои остались гнить на полях, где ты оттачивал своё древнее ремесло. Ты больше не спишь спокойно по ночам, тебе не нравится вспоминать, что тебе приходилось делать, чтобы выжить. Обменять приключения на стабильную плату было единственным логичным решением, и, возможно, однажды ты сможешь опустить клинок и дать отдых своему уставшему телу..."
