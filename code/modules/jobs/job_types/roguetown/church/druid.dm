/datum/job/roguetown/druid
	...
	tutorial = "Далеко не все староверы согласы с Кодексом. Однако подобные инакомыслящие уже не приветствуются обществом, поэтому лучшем укрытием для них стали леса. Вы являетесь жителем одного лесного поселения рядом с городом. Вам позволяют жить рядом дабы исключить ещё большие конлфикты, а также благодаря вам сохраняется относительная безопасность там, где рискнуть находиться сможет не каждый. Грабьте, убивайте, похищайте, но в меру. Ваша территория - это ваша территория, но если вы рискнёте сунуться с недобрыми намерениями на городскую территорию - разговор с вами будет короткий."
