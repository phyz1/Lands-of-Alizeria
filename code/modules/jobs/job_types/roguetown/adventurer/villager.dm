/datum/job/roguetown/villager
	...
	tutorial = "Ты - обычный житель земель Ализерии. Тебя неособо волнуют нависающая над тобой власть господ, ведь иначе бы ты примкнул к их армии. Торгуй, живи и общайся, более от тебя ничего не ждут. Пока что..."
