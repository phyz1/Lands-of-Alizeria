/datum/advclass/sawbones // doctor class. like the pilgrim, but more evil
	name = "Sawbones"
	tutorial = "Это была случайность! Ваш пациент всё равно не использовал свою вторую почку. После досадного «недоразумения» с городом, вы теперь занимаетесь полевой медициной со своими новыми коллегами. Дела идут как никогда хорошо!"
