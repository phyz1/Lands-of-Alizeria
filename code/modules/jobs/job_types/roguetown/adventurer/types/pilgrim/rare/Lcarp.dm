...
/datum/advclass/mastercarpenter
	...
	tutorial = "Ты мастер-плотник, в отличие от каменщиков, ты отправился познавать тайны дерева. Эльфы, созданные Дендором, научили тебя превращать дерево во что угодно."
