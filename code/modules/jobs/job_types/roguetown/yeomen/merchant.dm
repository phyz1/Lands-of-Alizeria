/datum/job/roguetown/merchant
	...
	tutorial = "Портовый город никак не может обходиться без торговли, впрочем, как и любой иной город. У тебя есть собственная лавка в пределах городских стен, а также налаженные торговые связи, благодаря которым ты можешь вести вполне себе успешную торговлю."
