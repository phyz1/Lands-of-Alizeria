...
/obj/structure/roguemachine/vendor/houses
	keycontrol = "steward"
	will_hawk = FALSE

/obj/structure/roguemachine/vendor/houses/Initialize()
	. = ..()
	for (var/X in list(/obj/item/roguekey/alizeria/house3, /obj/item/roguekey/alizeria/house2, /obj/item/roguekey/alizeria/house1))
		var/obj/P = new X(src)
		held_items[P] = list()
		held_items[P]["NAME"] = P.name
		held_items[P]["PRICE"] = 120

	for (var/X in list(/obj/item/roguekey/alizeria/house9, /obj/item/roguekey/alizeria/house10, /obj/item/roguekey/alizeria/house11))
		var/obj/P = new X(src)
		held_items[P] = list()
		held_items[P]["NAME"] = P.name
		held_items[P]["PRICE"] = 200

	for (var/X in list(/obj/item/roguekey/alizeria/noblehouse1, /obj/item/roguekey/alizeria/noblehouse2, /obj/item/roguekey/alizeria/noblehouse3))
		var/obj/P = new X(src)
		held_items[P] = list()
		held_items[P]["NAME"] = P.name
		held_items[P]["PRICE"] = 350

/obj/structure/roguemachine/vendor/hotel
	keycontrol = "hotel"
	will_hawk = FALSE

/obj/structure/roguemachine/vendor/hotel/Initialize()
	. = ..()
	for (var/X in list(/obj/item/roguekey/alizeria/room1, /obj/item/roguekey/alizeria/room2, /obj/item/roguekey/alizeria/room3))
		var/obj/P = new X(src)
		held_items[P] = list()
		held_items[P]["NAME"] = P.name
		held_items[P]["PRICE"] = 20

	for (var/X in list(/obj/item/roguekey/alizeria/room4, /obj/item/roguekey/alizeria/room5, /obj/item/roguekey/alizeria/room6))
		var/obj/P = new X(src)
		held_items[P] = list()
		held_items[P]["NAME"] = P.name
		held_items[P]["PRICE"] = 40

	for (var/X in list(/obj/item/roguekey/alizeria/room7, /obj/item/roguekey/alizeria/room8, /obj/item/roguekey/alizeria/room9))
		var/obj/P = new X(src)
		held_items[P] = list()
		held_items[P]["NAME"] = P.name
		held_items[P]["PRICE"] = 60

/obj/structure/roguemachine/vendor/bath
	keycontrol = "capo"

/obj/structure/roguemachine/vendor/bath/Initialize()
	. = ..()

	// Add room keys with a price of 20
	for (var/X in list(/obj/item/clothing/mask/cigarette/rollie/nicotine, /obj/item/clothing/mask/cigarette/rollie/nicotine, /obj/item/clothing/mask/cigarette/rollie/nicotine, /obj/item/clothing/mask/cigarette/rollie/nicotine, /obj/item/clothing/mask/cigarette/rollie/nicotine, /obj/item/clothing/mask/cigarette/rollie/nicotine, /obj/item/clothing/mask/cigarette/rollie/nicotine, /obj/item/clothing/mask/cigarette/rollie/nicotine, /obj/item/clothing/mask/cigarette/rollie/nicotine, /obj/item/clothing/mask/cigarette/rollie/nicotine))
		var/obj/P = new X(src)
		held_items[P] = list()
		held_items[P]["NAME"] = P.name
...
/obj/structure/roguemachine/vendor/inn/Initialize()
	...
	// Add room keys with a price of 20
	for (var/X in list(/obj/item/roguekey/alizeria/roomo, /obj/item/roguekey/alizeria/roomtw, /obj/item/roguekey/alizeria/roomth, /obj/item/roguekey/alizeria/roomf, /obj/item/roguekey/alizeria/roomfi))
		var/obj/P = new X(src)
		held_items[P] = list()
		held_items[P]["NAME"] = P.name
		held_items[P]["PRICE"] = 40
	...
	for (var/Y in list(/obj/item/roguekey/alizeria/roomsix))
		var/obj/Q = new Y(src)
		held_items[Q] = list()
	...
	for (var/Z in list(/obj/item/roguekey/alizeria/roomsev, /obj/item/roguekey/alizeria/roomeight))
		var/obj/F = new Z(src)
		held_items[F] = list()
