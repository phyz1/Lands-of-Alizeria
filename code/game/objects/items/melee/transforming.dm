/obj/item/melee/transforming
	...
	var/list/attack_verb_on = list("атакует", "режет", "колит", "разрезает", "рвёт", "разрывает", "diced", "секёт")
	var/list/attack_verb_off = list("атакует", "режет", "колит", "разрезает", "рвёт", "разрывает", "diced", "секёт")
