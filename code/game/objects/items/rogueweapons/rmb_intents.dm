...
/datum/rmb_intent/aimed
	name = "aimed"
	desc = "Атаки более точны, но совершать их становится медленнее. Повышенный шанс нанести критический удар точными атаками.\n(ПКМ В АКТИВНОМ БОЕВОМ РЕЖИМЕ) Приманка для противника - ваша конечность, на которую вы нацелены. Если противник ударит в неё - он потеряет равновесие."
	icon_state = "rmbaimed"
...
/datum/rmb_intent/strong
	name = "strong"
	desc = "Атаки получают +1 к Силе, но расходают больше выносливости. Повышает шанс брутальных атак. Намеренно проваливает этапы хирургического вмешательства."
...
/datum/rmb_intent/swift
	name = "swift"
	desc = "Атаки более быстры, но менее точны."
	icon_state = "rmbswift"

/datum/rmb_intent/special
	name = "special"
	desc = "(ПКМ В АКТИВНОЙ ЗАЩИТЕ) Специальная атака, которая зависит от типа используемого вами оружия."
	icon_state = "rmbspecial"

/datum/rmb_intent/feint
	name = "feint"
	desc = "(ПКМ В АКТИВНОМ БОЕВОМ РЕЖИМЕ) Обманчивая полуатака без продолжения, предназначенная для того, чтобы заставить противника ослабить бдительность."
	icon_state = "rmbfeint"
